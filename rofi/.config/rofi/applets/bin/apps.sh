...
term_cmd='kitty'
file_cmd='kitty -e lf'
text_cmd=(code --ozone-platform="wayland" --enable-features="WaylandWindowDecorations")
web_cmd='firefox'
music_cmd=(spotify --ozone-platform="wayland" --enable-features="WaylandWindowDecorations")
